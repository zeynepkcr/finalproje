...
try:
    data = [
        ...
        [None, hasta2.ad, hasta2.soyad, None, None, None, None, None, None, hasta2.hasta_no, hasta2.dogum_tarihi, hasta2.hastalik, hasta2.tedavi],
        [None, hasta3.ad, hasta3.soyad, None, None, None, None, None, None, hasta3.hasta_no, hasta3.dogum_tarihi, hasta3.hastalik, hasta3.tedavi]
    ]
    ...
    print(f"DataFrame islenirken bir hata olustu: {e}")
